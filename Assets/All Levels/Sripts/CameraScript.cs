...
public class CameraScript : MonoBehaviour {
	...
	void Start () {
		...
		vecFromPlayer = playerInfo.vecToMainCam;
	}
	...
	void LateUpdate() {
		...
		//transform.position = player.transform.position + (player.transform.rotation * vecFromPlayer * playerInfo.cameraDistMult);
		transform.position = player.transform.position + player.transform.TransformVector(vecFromPlayer) * playerInfo.cameraDistMult;
